...
> 详细内容 → [references/layout-rules.md](references/layout-rules.md)（间距规则、箭头标签、路由、验证清单）
...
> **⚠️ SVG 生成策略** → [references/svg-generation.md](references/svg-generation.md)（Python列表法、错误恢复、语法检查）
