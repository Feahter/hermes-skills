...
metadata:
  ...
  combinator:
    triggers: ['p5js', '创意编程', '生成艺术', '交互艺术', 'p5.js']
---
...
> 代码示例和详细说明 → [references/implementation-notes.md](references/implementation-notes.md)（性能优化、seeding、颜色模式、噪声、createGraphics、WebGL陷阱、导出快捷键、headless渲染）
