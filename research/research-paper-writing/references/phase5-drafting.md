# Phase 5: Paper Drafting — Full Reference

**Goal**: Write a complete, publication-ready paper.

For the condensed SKILL.md version of this phase, see [Phase 5 Summary](#phase-5-paper-drafting) in the main skill.
...
- [references/writing-guide.md](writing-guide.md) — Full explanations with examples
- [references/sources.md](sources.md) — Complete bibliography
...
**Full writing guide with examples**: See [references/writing-guide.md](writing-guide.md)
...
## Step-by-Step Drafting Guidance (5.1-5.8)
...
#
> **📖 Writing Style (extended)** → [references/writing-style.md](references/writing-style.md)


> **📖 LaTeX Templates & Packages (extended)** → [references/phase5-drafting.md](references/phase5-drafting.md)
